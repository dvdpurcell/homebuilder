    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="homebuilderApp.category.home.createOrEditLabel">
              <Translate contentKey="homebuilderApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : categoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="homebuilderApp.category.name">Name</Translate>
                  </Label>
                  <AvField
                    id="category-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="homebuilderApp.category.description">Description</Translate>
                  </Label>

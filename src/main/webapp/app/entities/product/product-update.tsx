    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="homebuilderApp.product.home.createOrEditLabel">
              <Translate contentKey="homebuilderApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : productEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="modelNumberLabel" for="modelNumber">
                    <Translate contentKey="homebuilderApp.product.modelNumber">Model Number</Translate>
                  </Label>
                  <AvField id="product-modelNumber" type="text" name="modelNumber" />
                </AvGroup>
                <AvGroup>
                  <Label id="technicalSpecsLabel" for="technicalSpecs">
                    <Translate contentKey="homebuilderApp.product.technicalSpecs">Technical Specs</Translate>
                  </Label>
                  <AvField id="product-technicalSpecs" type="text" name="technicalSpecs" />
                </AvGroup>
